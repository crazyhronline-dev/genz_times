...
export const metadata: Metadata = {
  ...
  title: {
    default: "GenZ Time | Real Gadget Reviews, Lab Benchmarks & Next-Gen Tech",
  ...
  twitter: {
    ...
    title: "GenZ Time | Real Gadget Reviews, Lab Benchmarks & Next-Gen Tech",
    description: "We test every device with our own hands before publishing. Honest reviews, lab benchmarks and AI gadget tests built for Gen Z.",
